...
callbacks = [
    ...
    SaveModelCallback(fname='efficientnetv2',monitor='cohen_kappa_score'),
    ReduceLROnPlateau(patience=2), ProgressiveResizingRandAugment([0,100,200,300,350],[224,384,512,640,640],[128,224,384,512,512],[0,2,4,6,8],128,'efficientnetv2')
]
...
learn = Learner(dlsTrain3,timm.create_model('efficientnetv2_rw_s',num_classes=2,pretrained=True),
