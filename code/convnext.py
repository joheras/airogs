...
callbacks = [
    ...
    SaveModelCallback(fname='convnext_base',monitor='cohen_kappa_score'),
    ReduceLROnPlateau(patience=2), ProgressiveResizingRandAugment([0,100,200,300,350],[224,384,512,640,640],[128,224,384,512,512],[0,2,4,6,8],64,'convnext_base')
]
...
learn = Learner(dlsTrain3,timm.create_model('convnext_base',num_classes=2,pretrained=True),
